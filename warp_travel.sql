...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 02 fév. 2024 à 03:57
...
--
-- Index pour la table `subit`
--
ALTER TABLE `subit`
  ADD PRIMARY KEY (`Id_Routes_Tracee`,`Id_Rencontre_Warp`);
